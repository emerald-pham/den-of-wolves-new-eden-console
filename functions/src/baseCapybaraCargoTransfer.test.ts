...
describe('base Capybara Cargo Transfer', () => {
  ...
  it.each([
    ...
    ['missing base Capybara', { activeVesselIds: ['aegis'] }, /active base Capybara/i],
    ['expansion Capybara mixed in', { activeVesselIds: ['aegis', 'capybara-small', 'capybara'] }, /active base Capybara/i],
    ['undocked Capybara', { smallShipState: emptySmallShipState('capybara-small') }, /docked with one host/i],
    ['inactive host', { activeVesselIds: ['dione', 'capybara-small'] }, /active host/i],
  ...
  it.each([
    ['duplicate active vessel', { activeVesselIds: ['aegis', 'capybara-small', 'aegis'] }],
    ['rogue active vessel', { activeVesselIds: ['aegis', 'capybara-small', 'rogue-vessel'] }],
