...
beforeEach(() => {
  ...
  mock.get.mockImplementation(async (ref: string | { path: string }) => {
    ...
    const fields: Record<string, unknown> = path.includes('/players/') ?
      ...
      { currentTurn: mock.currentTurn, activeRoleIds: mock.activeRoleIds, pressEnabled: mock.pressEnabled, confettiUsedShipIds: mock.usedShipIds };
...
it('does not let an enabled Press dispenser be forged by a connected non-Press member', async () => {
  mock.full = false;
  mock.post = 'admiral';
