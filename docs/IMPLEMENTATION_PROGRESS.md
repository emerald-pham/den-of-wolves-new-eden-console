...
| 535 | done | non-feature | — | Implemented facilitator-only Civil Unrest resolution records against the current debated crisis, linking current grievance revisions without automatic game effects or public publication. |
